...
const {
  payments,
  handleFormulaButton
} = require('#src/modules/payments/payments')
...
global.DIR_J = process.env.DIR_J
global.DIR_F = process.env.DIR_F
global.DIR_K = process.env.DIR_K
