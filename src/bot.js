...
const { metricsNotification, metricsNotificationProiz } = require('#src/modules/metrics')
...
bot.command('metrics_director_notification', (ctx) => metricsNotification(ctx, 0))
bot.command('metrics_proizvotstvo_notification', (ctx) => metricsNotificationProiz(ctx, 0))
